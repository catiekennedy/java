...
* @version 1.0
* @since   2016-10-04
* <h1>RandomSkyline will have a random number of rectangular buildings with windows.</h1>
* <p>
*input: RandomSkylinePanel
*output: random number of black buildings with yellow windows on a blue background
*/
